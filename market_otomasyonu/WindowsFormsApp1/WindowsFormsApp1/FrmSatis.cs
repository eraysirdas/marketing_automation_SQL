...
namespace WindowsFormsApp1
{
    public partial class FrmSatis : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            textpuan.Enabled = false;
            txtID.Text = 01.ToString();
            sepetlistele();
        ...
        private void txtBarkod_TextChanged(object sender, EventArgs e)
        {
            ...
            while (r.Read())
            {
                ...
                txturunpuan.Text = r["puan"].ToString();
        ...
        private void button14_Click(object sender, EventArgs e)
        {
            ...
            {
                baglanti.Open();
                SqlCommand cmd = new SqlCommand("insert  into sepet(tel,ad,soyad,barkodno,urunadi,miktari,satisfiyati,toplamfiyati,tarih,sepet_ID,puan) values (@tel,@ad,@soyad,@barkodno,@urunadi,@miktari,@satisfiyati,@toplamfiyati,@tarih,'" + random.Next(50, 100) + "',@puan) ", baglanti);

                {
                    ...
                    cmd.Parameters.AddWithValue("@puan", int.Parse(txturunpuan.Text));
            ...
            else
            {
                ...
                SqlCommand cmd4 = new SqlCommand("update sepet set puan=miktari * puan where barkodno='" + txtBarkod.Text + "'", baglanti);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            cmd.ExecuteNonQuery();
            baglanti.Close();
            MessageBox.Show("ürün sepeti iptal edildi");
            ds.Tables["sepet"].Clear();
            sepetlistele();
            hesapla();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                baglanti.Open();
                SqlCommand cmd = new SqlCommand("insert into satis(tel,ad,soyad,barkodno,urunadi,miktari,satisfiyati,toplamfiyati,tarih,satis_ID,puan) values (@tel,@ad,@soyad,@barkodno,@urunadi,@miktari,@satisfiyati,@toplamfiyati,@tarih,'" + rand.Next(50, 100) + "',@puan) ", baglanti);

                {
                    cmd.Parameters.AddWithValue("@tel", txtID.Text);
                    cmd.Parameters.AddWithValue("@ad", txtadsoyad.Text);
                    cmd.Parameters.AddWithValue("@soyad", textpuan.Text);
                    ...
                    cmd.Parameters.AddWithValue("@puan", int.Parse(dataGridView1.Rows[i].Cells["puan"].Value.ToString()));
                    cmd.Parameters.AddWithValue("@tarih", DateTime.Now.ToString());
        ...
        private void txtID_TextChanged(object sender, EventArgs e)
        {
            ...
            while (r.Read())
            {
                ...
                textpuan.Text = r["puan"].ToString();
            }
            baglanti.Close();
        }
       /* private void textpuan_TextChanged(object sender, EventArgs e)
        {
            baglanti.Open();
            SqlCommand cmd = new SqlCommand("Select *from satis where tel like'" + txtID.Text + "'", baglanti);
            SqlDataReader r = cmd.ExecuteReader();
            while (r.Read())
            {
                txtadsoyad.Text = r["ad"].ToString();
